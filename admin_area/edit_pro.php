...
<html>
    ...
    <body bgcolor=skyblue">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <table align="center" width="795" border="2" bgcolor="lightgreen">
                ...
                <tr>
                    ...
                    <td><input type="text" name="product_title" size="60" value="<?=$pro_title;?>"/></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="file" name="product_image" /> <img src="product_images/<?=$pro_image;?>" width="60" height="60" /></td>
                </tr>
                
                <tr>
                    
                    <td align="right"><b>Product Price:</b></td>
                    <td><input type="text" name="product_price" value="<?=$pro_price;?>" /></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="product_desc" cols="20" rows="10"><?=$pro_desc;?></textarea> </td>
                </tr>
                
                <tr>
                    
                    <td align="right"><b>Product Keywords:</b></td>
                    <td><input type="text" name="product_keywords" size="50" value="<?=$pro_keywords;?>"/></td>
                </tr>
