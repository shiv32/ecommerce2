...
if(mysqli_connect_errno()){
    ...
    echo "The connetion was not established:" . mysqli_connect_error();
...
function getCatPro(){
    ...
    $count_cats = mysqli_num_rows($run_cat_pro);
     ...
     if($count_cats == 0){
        ...
        echo "<br>";
        echo "<h2>Please try after sometime!!</h2>";
